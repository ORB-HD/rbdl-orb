...
struct RBDL_DLLAPI ConstraintSet {
  ...
  */
  ...
  /**
      ...
      @param constraintBodyIdsOutput:  a reference to a vector of body ids
      ...
      @param constraintBodyFramesOutput: a reference to a vector of frames
      ...
      @param constraintForcesOutput: a reference to a vector of spatial
